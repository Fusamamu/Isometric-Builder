...
//    }
    ...
    func add_wall_collision(){
        ...
        wall.alpha = 0.25
        wall.zPosition = 100
        //need to figure out how to scale map size down properly, corresponding to map tiles//
        //Ok, now it works. donot need to scale wall size, but need to put setScale method out to somewhere
        //wall.setScale(0.25)
...
//        wall.physicsBody = SKPhysicsBody.init(rectangleOf: get_map_size())
    ...
    //need further understand on this method*****
...
//    func set_scale(of tile : SKShapeNode, _ scale: CGFloat) {
//        tile_width  *= scale
//        tile_height *= scale
//        tile.setScale(scale)
//    }
